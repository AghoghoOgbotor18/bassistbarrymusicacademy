...
const timeline = [
    {
        year: "2014",
        title: "First Bass Guitar",
        description: "Barry picked up his first bass guitar at 18 with no formal training — just raw curiosity and a deep love for gospel music.",
    },
    {
        year: "2016",
    ...
    },
    {
        year: "2022",
        title: "BBMA is Born",
        description: "After years of being asked by fellow musicians 'how do you play like that?', Barry launched Bassist Barry Music Academy to share everything he'd learned.",
    },
    {
        year: "2024",
            ...
            <div className="max-w-6xl mx-auto">
                <div className="grid lg:grid-cols-2 gap-16 items-start">
                    ...
                    <div>
                        ...
                        {/* Quote block */}
                        <div className="mt-10 border-l-4 border-maple pl-6 py-2">
