...
const stats = [
    {
        icon: <FaGuitar className="text-maple text-3xl" />,
        value: "10+",
        label: "Years Playing Bass",
        description: "A decade of professional experience on stages and in studios",
    },
    {
    ...
    {
        icon: <FaStar className="text-maple text-3xl" />,
        value: "3",
        label: "Course Tiers",
        description: "Beginner, Intermediate and Advanced — a path for everyone",
    },
    {
        icon: <FaMusic className="text-maple text-3xl" />,
        value: "100%",
        label: "Gospel-Focused",
        description: "Techniques and styles rooted in Nigeria's richest musical tradition",
    },
];
                    ...
                    {stats.map((stat, i) => (
                        ...
                        >
                            ...
                            <div className="relative z-10">
                                ...
                                <p className="font-display text-4xl font-bold text-parchment mb-1">
                                    {stat.value}
                                </p>
                                <p className="text-maple font-mono text-xs tracking-widest uppercase mb-2">
                                    {stat.label}
                                </p>
