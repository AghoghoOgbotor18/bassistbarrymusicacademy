...
const pillars = [
    { icon: <FaEye className="text-maple text-xl" />, heading: "Our Vision", text: "To be the leading bass guitar education platform in Nigeria — producing confident, skilled, and musically intelligent bassists who transform every band they join." },
    { icon: <FaBullseye className="text-maple text-xl" />, heading: "Our Mission", text: "To make world-class bass education accessible to every Nigerian, regardless of background — through structured courses, real-world techniques, and genuine mentorship." },
    { icon: <FaHeart className="text-maple text-xl" />, heading: "Our Values", text: "Excellence, consistency, and community. We believe great musicians are made through repetition and encouragement — and BBMA is built to provide both." },
];
        ...
        <section className="bg-parchment py-24 px-4 overflow-hidden">
            <div className="max-w-6xl mx-auto">
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    {/* Right pillars — slide in from right, staggered */}
                    <motion.div
