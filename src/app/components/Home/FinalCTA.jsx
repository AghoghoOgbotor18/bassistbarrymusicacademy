            ...
            <div className="max-w-4xl mx-auto">
                <div className="relative bg-ebony rounded-3xl px-8 py-16 md:px-16 text-center overflow-hidden">
                    ...
                    <div className="relative z-10">
                        ...
                        <p className="text-parchment/60 max-w-xl mx-auto mb-10 leading-relaxed">
                        ...
                        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                            ...
                            <a
                                href="/courses"
                                className="text-parchment/70 hover:text-maple transition text-sm underline underline-offset-4"
                            >
                                Browse courses first
                            </a>
                        </div>

                        <p className="text-parchment/30 text-xs mt-8">
